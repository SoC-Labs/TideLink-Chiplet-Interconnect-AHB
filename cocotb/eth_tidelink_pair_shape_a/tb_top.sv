...
`endif
    ...
    // ---- die_b ethernet-subsystem clocks (SIMPLIFICATIONS 1,2) --------------
    wire  eth_sys_fclk = hclk;                      // SIMP 1: SYS_HCLK == hclk
    logic eth_mtx_clk = 1'b0; always #20 eth_mtx_clk = ~eth_mtx_clk;  // 25 MHz
    logic eth_mrx_clk = 1'b0; always #20 eth_mrx_clk = ~eth_mrx_clk;  // 25 MHz
...
`endif
    ethernet_ss_ahb #(
        ...
        .cpu_0_iordata   (32'h0),
        .cpu_0_iomaster  (),
        // RTC / PTP (benign clock; PTP outputs observed only)
        .rtc_clk         (eth_rtc_clk),
        .rtc_time_ptp_ns (),
        .rtc_time_ptp_sec(),
        .rtc_time_one_pps(),
        // MII (benign clocks; MAC datapath not exercised)
