...
hardware diagnosis (docs/PHY_ALIGN_NEXT_STEPS.md §1.1: "swi_phase_offset
proven insufficient: 256-combo sweep, 0 winners"). Per that same doc
(§"don't replace swi_phase_offset … bit-slip and phase compose") the
...
async def test_per_lane_phase_is_independent(dut):
    ...
    # per docs/PHY_ALIGN_NEXT_STEPS.md §"don't replace swi_phase_offset").
