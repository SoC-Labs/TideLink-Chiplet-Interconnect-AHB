// ---------------------------------------------------------------------------
// tb_top_7.sv  --  unit testbench for the AR-channel (0x83) a2l replay FIFO node
// WlinkGenericFCReplayV2_7 (101-bit data / 4-bit ptr / depth-8).
//
