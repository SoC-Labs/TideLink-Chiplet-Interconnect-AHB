...
_Static_assert(sizeof(TIDELINK_CFG_TypeDef) == 0x034,
               "TIDELINK_CFG_TypeDef size mismatch");
_Static_assert(offsetof(TIDELINK_CFG_TypeDef, PAIR_BASE) == 0x000,
               "PAIR_BASE offset mismatch");
_Static_assert(offsetof(TIDELINK_CFG_TypeDef, STATUS) == 0x010,
               "STATUS offset mismatch");
_Static_assert(offsetof(TIDELINK_CFG_TypeDef, CTRL) == 0x01C,
               "CTRL offset mismatch");
_Static_assert(offsetof(TIDELINK_CFG_TypeDef, RELEASED_ACC) == 0x020,
               "RELEASED_ACC offset mismatch");
_Static_assert(offsetof(TIDELINK_CFG_TypeDef, PAIR_CREDIT_EN) == 0x030,
               "PAIR_CREDIT_EN offset mismatch");

/* ── 64-bit safe init wrapper ───────────────────────────────────────────── */

void tidelink_init_host(tidelink_t *tl, void *cfg_ptr, void *fifo_ptr)
{
    tl->cfg  = (TIDELINK_CFG_TypeDef *)cfg_ptr;
