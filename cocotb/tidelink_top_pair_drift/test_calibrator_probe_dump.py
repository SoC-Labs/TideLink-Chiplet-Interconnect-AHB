...
# Drift-variant outputs — distinct paths so the original tidelink_top_pair
# probe dump (Agent D) is NOT overwritten.
_SCEN = os.environ.get("AGENT_M_SCENARIO", "scenA_biasfix")
DUMP_PATH = DOCS_DIR / f"agent_m_probe_dump_{_SCEN}.log"
FINDINGS_PATH = DOCS_DIR / f"agent_m_probe_findings_{_SCEN}.md"
