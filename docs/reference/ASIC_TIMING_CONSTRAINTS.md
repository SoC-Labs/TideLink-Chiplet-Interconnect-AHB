...
- Determinism measurement of any candidate fix:
  `docs/reference/DETERMINISM_VALIDATION.md` +
...
- **CDC sign-off:** run a structural CDC checker (the flow's CDC tool)
  ...
  `docs/reference/SPYGLASS_CDC_SIGNOFF.md` for the live sign-off state.
...
- [ ] **Determinism re-validated.** After the constraint/delay-cell
      ...
      (`docs/reference/DETERMINISM_VALIDATION.md`) shows a stable both-sides-good
