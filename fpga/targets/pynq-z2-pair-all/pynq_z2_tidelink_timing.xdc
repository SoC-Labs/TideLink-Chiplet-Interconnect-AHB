...
#
# NOTE: the guard for "did this actually apply?" deliberately does NOT live here.
# Procedural Tcl (if/error) inside an XDC trips [Designutils 20-1307] and Vivado
# MAY DROP THE CONSTRAINT — i.e. a guard written here could CAUSE the very silent
# no-op it is meant to prevent. The assertion lives in fpga/build_design.tcl
# (STEP 10b), which is a real Tcl script. Keep this file declarative.
