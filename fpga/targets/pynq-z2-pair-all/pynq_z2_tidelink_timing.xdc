...
set _xlnx_shared_i0 [get_cells -hier -filter {NAME =~ "*gpiorx_*/link_data_pad_clk_reg[*]" || NAME =~ "*gpiorx_*/g_t3a_realign.realign_shifter_reg[*]"}]
...
set_bus_skew -from [get_ports {pad_rx[*]}] -to [get_cells -hier -filter {NAME =~ "*gpiorx_*/link_data_pad_clk_reg[*]" || NAME =~ "*gpiorx_*/g_t3a_realign.realign_shifter_reg[*]"}] 2.000
