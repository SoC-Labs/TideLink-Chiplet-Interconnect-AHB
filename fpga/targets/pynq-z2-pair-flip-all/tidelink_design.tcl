...
proc create_root_design { parentCell } {
    ...
    # baseline (OFF, byte-identical to every prior pynq-z2-pair-flip-all image,
    # and to every KR260 target which never sets this); export
    # TL_EPOCH_ANCHOR_EN=1 to build the data-delivery-fix HW-test image.
    # Reaches OOC synth via the wrapper IP-face parameter — a +define+ would
    # NOT (same class of trap as TRAIN_ENTRY_FALLBACK / DEBUG_UNLOCK_DEFAULT).
