...
###-----------------------------------------------------------------------------
### TARGET A (mmcmbypass-all variant, 2026-05-28):
###   Same BD topology as pynq-z2-pair-all, with one structural change on the
###   slave-side RX clock path: pad_clk_rx is routed through an explicit
###   single-instance IBUFG + BUFG (tidelink_clk_rx_buf wrapper module)
###   before reaching tidelink_0/pad_clk_rx, instead of fanning out to 8
###   per-lane BUFGs inside WavD2DGpio. This cuts the on-pad capacitive load
###   from ~48 pF to ~8 pF and recovers slave-side LVCMOS33 swing under the
###   PYNQ-Z2's 200 Ω external series resistance.
###
