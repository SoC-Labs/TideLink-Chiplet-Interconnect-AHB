...
###-----------------------------------------------------------------------------
### TARGET A FLIP (mmcmbypass-flip-all variant, 2026-05-28):
###   Mirror of pynq-z2-pair-mmcmbypass-all with the FLIP-pair XDC pinout
###   (cross-cable RPi pin assignment). The BD topology is identical: a
###   single IBUFG+BUFG (tidelink_clk_rx_buf wrapper module) sits between
###   the pad_clk_rx port and tidelink_0/pad_clk_rx, replacing the
###   direct-net connection used by pynq-z2-pair-flip-all.
###
