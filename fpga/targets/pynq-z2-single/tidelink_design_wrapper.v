...
//
//   - role_strap_i = 1'b0        (slave; hardcoded for single-instance target)
...
module tidelink_design_wrapper (
    ...
    tidelink_design tidelink_design_i (
        ...
        // All other tie-offs (role_strap_i, tl_bcast_ack_i, phc_pps,
        // phc_locked_i, tc_axis_*, tc_qos_priority, user_ref_clk,
        // scan_*, i2c_*, ahb_mng_*, s_i2c_axi_*) are driven INSIDE the
        // block design via xlconstant cells in tidelink_design.tcl. They
        // are not exposed as BD external ports, so they do not appear in
        // this instantiation.
    );
