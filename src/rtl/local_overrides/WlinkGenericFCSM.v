...
module WlinkGenericFCSM(
  ...
  input  [100:0] io_app_a2l_data,
  output         io_app_a2l_ready,
  output         io_app_l2a_valid,
  output [100:0] io_app_l2a_data,
  ...
  // ===========================================================================
  // SoC Labs XHB500 FC-node hardening -- LIGHTER variant (2026-07-04): Fixes
  // A-E + CRC-off default only. Fix F (L9b) + L9 substrate and the Bug-C CDC
  // fix are OMITTED to relieve die_b RX-capture-clock hold timing. Constants are
  // LOCALPARAMS (internal) so the module port list stays byte-identical to the
  // pristine Chisel node.
  //   SOCL_L6_MIN_CR_EMITS    : min CR emits held in state 1    (Fix B)
  //   SOCL_L7_MIN_CRACK_EMITS : min CRACK emits held in state 2 (Fix C)
  //   SOCL_L7_WDOG_THRESHOLD  : state-7 NACK watchdog trip       (Fix D)
...
`endif // RANDOMIZE_REG_INIT
  wire [111:0] rx_crc_computed_crcgen_io_in; // @[LinkLayer.scala 1274:24]
  ...
  wire [100:0] l2a_fc_replay_app_data; // @[FC.scala 219:43]
  ...
  wire [3:0] l2a_fc_replay_link_ack_addr; // @[FC.scala 219:43]
  wire [3:0] l2a_fc_replay_link_cur_addr; // @[FC.scala 219:43]
  wire [100:0] l2a_fc_replay_link_data; // @[FC.scala 219:43]
  ...
  wire [3:0] l2a_fifo_addr_to_tx_w_addr; // @[FC.scala 241:43]
  wire  l2a_fifo_addr_to_tx_r_clk; // @[FC.scala 241:43]
  wire  l2a_fifo_addr_to_tx_r_reset; // @[FC.scala 241:43]
  wire [3:0] l2a_fifo_addr_to_tx_r_addr; // @[FC.scala 241:43]
  ...
  wire [100:0] a2l_fc_replay_app_data; // @[FC.scala 297:43]
  ...
  wire [3:0] a2l_fc_replay_link_ack_addr; // @[FC.scala 297:43]
  wire  a2l_fc_replay_link_revert; // @[FC.scala 297:43]
  wire [3:0] a2l_fc_replay_link_revert_addr; // @[FC.scala 297:43]
  wire [3:0] a2l_fc_replay_link_cur_addr; // @[FC.scala 297:43]
  wire [100:0] a2l_fc_replay_link_data; // @[FC.scala 297:43]
  ...
  wire [111:0] bundleOut_0_crc_crcgen_io_in; // @[LinkLayer.scala 1274:24]
  wire [15:0] bundleOut_0_crc_crcgen_io_out; // @[LinkLayer.scala 1274:24]
  wire [103:0] ll_rx_data = auto_rx_in_data[111:8]; // @[FC.scala 122:33]
  wire [7:0] ll_rx_pktnum = auto_rx_in_data[7:0]; // @[FC.scala 123:33]
`ifdef TL035_ILA_TAPS
 `define TL035_DBG (* mark_debug = "true" *)
`else
 `define TL035_DBG
`endif
  `TL035_DBG reg [2:0] state; // @[FC.scala 143:91]  // TL-035 ILA tap
  ...
  reg [111:0] link_data; // @[FC.scala 324:48]
  reg [7:0] count; // @[FC.scala 331:48]
  wire [3:0] link_ack_addr = ack_nack_fifo_io_rdata[3:0]; // @[FC.scala 334:64]
  reg  ack_seen_before; // @[FC.scala 340:48]
  wire  _ack_seen_before_T = state == 3'h0; // @[FC.scala 341:53]
  wire [7:0] _GEN_315 = {{4'd0}, link_ack_addr}; // @[FC.scala 348:89]
  wire [3:0] _link_revert_addr_T_5 = link_ack_addr + 4'h1; // @[FC.scala 348:158]
  wire [3:0] _link_revert_addr_T_6 = _GEN_315 == 8'hf ? 4'h0 : _link_revert_addr_T_5; // @[FC.scala 348:47]
  ...
  reg [3:0] l2a_fifo_raddr_txclk_prev; // @[FC.scala 400:48]
  wire [3:0] l2a_fifo_raddr_txclk = l2a_fifo_addr_to_tx_r_addr; // @[FC.scala 240:41 FC.scala 249:35]
  ...
  `TL035_DBG reg  send_nack_req; // @[FC.scala 409:48]  // TL-035 ILA tap
  ...
  `TL035_DBG reg         socl_l7_real_crc_seen; // TL-035 ILA tap
  `TL035_DBG reg  [15:0] socl_l7_wdog_cnt; // TL-035 ILA tap
...
`endif
  ...
  // SoC Labs L6 (Fix B): hold state 1 until the min-CR-emit gate is met.
  ...
  wire [111:0] _GEN_38 = auto_tx_out_advance ? 112'h0 : link_data; // @[FC.scala 459:28 FC.scala 430:39]
  ...
  wire [15:0] _GEN_42 = socl_l7_crack_release ? 16'h0 : 16'hf0f; // @[FC.scala 476:34 FC.scala 479:39 FC.scala 486:39]
  ...
  // SoC Labs (Fix E): re-arm pulse for the periodic cumulative-ACK re-emit.
  ...
  wire [11:0] _word_count_in_T_4 = {l2a_fifo_raddr_txclk,word_count_in_lo}; // @[Cat.scala 30:58]
  wire  _T_59 = a2l_fc_replay_link_valid & ~fe_rx_is_full; // @[FC.scala 523:45]
  wire [7:0] link_data_in_lo = {{4'd0}, a2l_fc_replay_link_cur_addr}; // @[FC.scala 350:45 FC.scala 351:39]
  wire [108:0] _link_data_in_T = {a2l_fc_replay_link_data,link_data_in_lo}; // @[Cat.scala 30:58]
  ...
  wire [15:0] _GEN_57 = a2l_fc_replay_link_valid & ~fe_rx_is_full ? 16'he : word_count; // @[FC.scala 523:63 FC.scala 527:39 FC.scala 429:39]
  wire [111:0] _GEN_58 = a2l_fc_replay_link_valid & ~fe_rx_is_full ? {{3'd0}, _link_data_in_T} : link_data; // @[FC.scala 523:63 FC.scala 528:39 FC.scala 430:39]
  ...
  wire [15:0] _GEN_65 = send_ack_req & _T_54 ? {{4'd0}, _word_count_in_T_4} : _GEN_57; // @[FC.scala 514:50 FC.scala 519:39]
  wire [111:0] _GEN_66 = send_ack_req & _T_54 ? 112'h0 : _GEN_58; // @[FC.scala 514:50 FC.scala 520:39]
  ...
  wire [15:0] _GEN_74 = send_nack_req ? {{4'd0}, _word_count_in_T_4} : _GEN_65; // @[FC.scala 505:28 FC.scala 510:39]
  wire [111:0] _GEN_75 = send_nack_req ? 112'h0 : _GEN_66; // @[FC.scala 505:28 FC.scala 511:39]
  ...
  wire [111:0] _GEN_109 = auto_tx_out_advance ? _GEN_75 : link_data; // @[FC.scala 537:28 FC.scala 430:39]
...
`ifdef TL035_PARTB
  // TL-035 Part-B (state-7 EXIT, 2026-08-11): force the state-7 exit on the
  // watchdog trip too, so a pure emit-starvation stall (auto_tx_out_advance
  // flat-0) is broken -- HARD HANG -> bounded lost-NACK (peer data recovered by
  // the I5 outstanding-response backstop / re-ACK). BLIND-MERGE-FORBIDDEN: a
  // state-machine behaviour change; validate THRESHOLD vs the real 40ns round-
  // trip (die_a AW-FCSM ILA) before shipping. See scratchpad/plan_a2l_r1_fcsm.md §6.
...
`endif
  ...
  wire [111:0] _GEN_126 = send_nack_req ? 112'h0 : _GEN_58; // @[FC.scala 586:30 FC.scala 592:39]
  ...
  wire [111:0] _GEN_135 = auto_tx_out_advance ? _GEN_126 : link_data; // @[FC.scala 582:28 FC.scala 430:39]
  ...
  wire [111:0] _GEN_145 = state == 3'h6 ? _GEN_135 : link_data; // @[FC.scala 578:57 FC.scala 430:39]
  ...
  wire [111:0] _GEN_156 = state == 3'h7 ? link_data : _GEN_145; // @[FC.scala 571:58 FC.scala 430:39]
  ...
  wire [111:0] _GEN_165 = state == 3'h5 ? _GEN_109 : _GEN_156; // @[FC.scala 534:58]
  ...
  wire [111:0] _GEN_176 = state == 3'h4 ? _GEN_75 : _GEN_165; // @[FC.scala 501:58]
  ...
  WlinkCrcGen rx_crc_computed_crcgen ( // @[LinkLayer.scala 1274:24]
  ...
  WlinkGenericFCReplayV2 l2a_fc_replay ( // @[FC.scala 219:43]
  ...
  WlinkGenericFCReplayAddrSync l2a_fifo_addr_to_tx ( // @[FC.scala 241:43]
  ...
  WlinkGenericFCReplayV2_1 a2l_fc_replay ( // @[FC.scala 297:43]
  ...
  WlinkCrcGen bundleOut_0_crc_crcgen ( // @[LinkLayer.scala 1274:24]
  ...
  assign l2a_fc_replay_app_data = ll_rx_data[100:0]; // @[FC.scala 223:35]
  ...
  assign a2l_fc_replay_link_ack_addr = ack_nack_fifo_io_rdata[3:0]; // @[FC.scala 334:64]
  assign a2l_fc_replay_link_revert = ack_nack_fifo_io_rdata[18:16] == 3'h3 & ack_nack_fifo_valid; // @[FC.scala 290:73]
  assign a2l_fc_replay_link_revert_addr = ~ack_seen_before ? 4'h0 : _link_revert_addr_T_6; // @[FC.scala 347:45]
  ...
  // SoC Labs L6 (Fix B): CR-emit counter (io_tx_clk); saturates, re-arms out of state 1.
  always @(posedge io_tx_clk or posedge io_tx_reset) begin
    if (io_tx_reset) begin
  ...
  // SoC Labs L7 (Fix C): CRACK-emit counter (io_tx_clk); mirror of the L6 gate.
  always @(posedge io_tx_clk or posedge io_tx_reset) begin
    if (io_tx_reset) begin
  ...
  always @(posedge io_tx_clk or posedge io_tx_reset) begin
    if (io_tx_reset) begin
      ...
      if (auto_tx_out_advance) begin
        // SoC Labs L6 (Fix B): keep emitting CR until the min-emit gate is met.
  ...
  always @(posedge io_tx_clk or posedge io_tx_reset) begin
    if (io_tx_reset) begin
      l2a_fifo_raddr_txclk_prev <= 4'h0;
    end else begin
  ...
  always @(posedge io_tx_clk or posedge io_tx_reset) begin
    if (io_tx_reset) begin
      ...
      send_ack_req <= _GEN_178 | socl_reack_rearm; // SoC Labs Fix E re-ACK re-arm
    end
  end
  always @(posedge io_tx_clk or posedge io_tx_reset) begin
    if (io_tx_reset) begin
...
`endif
  ...
  // SoC Labs (Fix E): periodic re-ACK idle counter (io_tx_clk).
  always @(posedge io_tx_clk or posedge io_tx_reset) begin
    if (io_tx_reset) begin
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_22 = {1{`RANDOM}};
  l2a_fifo_raddr_txclk_prev = _RAND_22[3:0];
  _RAND_23 = {1{`RANDOM}};
...
`endif // RANDOMIZE_REG_INIT
  ...
  // SoC Labs (Fix E): init periodic re-ACK regs (defined from time 0).
  socl_reack_idle_cnt = 16'h0;
  socl_reack_fired    = 1'h0;
  if (io_tx_reset) begin
    ne_rx_ptr = 8'h0;
