...
module WlinkGenericFCSM_1(
  ...
  input  [36:0] io_app_a2l_data,
  output        io_app_a2l_ready,
  output        io_app_l2a_valid,
  output [36:0] io_app_l2a_data,
...
`endif // RANDOMIZE_REG_INIT
  wire [47:0] rx_crc_computed_crcgen_io_in; // @[LinkLayer.scala 1274:24]
  ...
  wire [36:0] l2a_fc_replay_app_data; // @[FC.scala 219:43]
  ...
  wire [5:0] l2a_fc_replay_link_ack_addr; // @[FC.scala 219:43]
  wire [5:0] l2a_fc_replay_link_cur_addr; // @[FC.scala 219:43]
  wire [36:0] l2a_fc_replay_link_data; // @[FC.scala 219:43]
  ...
  wire [5:0] l2a_fifo_addr_to_tx_w_addr; // @[FC.scala 241:43]
  wire  l2a_fifo_addr_to_tx_r_clk; // @[FC.scala 241:43]
  wire  l2a_fifo_addr_to_tx_r_reset; // @[FC.scala 241:43]
  wire [5:0] l2a_fifo_addr_to_tx_r_addr; // @[FC.scala 241:43]
  ...
  wire [36:0] a2l_fc_replay_app_data; // @[FC.scala 297:43]
  ...
  wire [5:0] a2l_fc_replay_link_ack_addr; // @[FC.scala 297:43]
  wire  a2l_fc_replay_link_revert; // @[FC.scala 297:43]
  wire [5:0] a2l_fc_replay_link_revert_addr; // @[FC.scala 297:43]
  wire [5:0] a2l_fc_replay_link_cur_addr; // @[FC.scala 297:43]
  wire [36:0] a2l_fc_replay_link_data; // @[FC.scala 297:43]
  ...
  wire [47:0] bundleOut_0_crc_crcgen_io_in; // @[LinkLayer.scala 1274:24]
  wire [15:0] bundleOut_0_crc_crcgen_io_out; // @[LinkLayer.scala 1274:24]
  wire [39:0] ll_rx_data = auto_rx_in_data[47:8]; // @[FC.scala 122:33]
  ...
  reg [47:0] link_data; // @[FC.scala 324:48]
  reg [7:0] count; // @[FC.scala 331:48]
  wire [5:0] link_ack_addr = ack_nack_fifo_io_rdata[5:0]; // @[FC.scala 334:64]
  reg  ack_seen_before; // @[FC.scala 340:48]
  wire  _ack_seen_before_T = state == 3'h0; // @[FC.scala 341:53]
  wire [7:0] _GEN_315 = {{2'd0}, link_ack_addr}; // @[FC.scala 348:89]
  wire [5:0] _link_revert_addr_T_5 = link_ack_addr + 6'h1; // @[FC.scala 348:158]
  wire [5:0] _link_revert_addr_T_6 = _GEN_315 == 8'h3f ? 6'h0 : _link_revert_addr_T_5; // @[FC.scala 348:47]
  ...
  reg [5:0] l2a_fifo_raddr_txclk_prev; // @[FC.scala 400:48]
  wire [5:0] l2a_fifo_raddr_txclk = l2a_fifo_addr_to_tx_r_addr; // @[FC.scala 240:41 FC.scala 249:35]
  ...
  wire [47:0] _GEN_38 = auto_tx_out_advance ? 48'h0 : link_data; // @[FC.scala 459:28 FC.scala 430:39]
  ...
  wire [15:0] _GEN_42 = socl_l7_crack_release ? 16'h0 : 16'h3f3f; // @[FC.scala 476:34 FC.scala 479:39 FC.scala 486:39]
  ...
  wire [13:0] _word_count_in_T_4 = {l2a_fifo_raddr_txclk,word_count_in_lo}; // @[Cat.scala 30:58]
  wire  _T_59 = a2l_fc_replay_link_valid & ~fe_rx_is_full; // @[FC.scala 523:45]
  wire [7:0] link_data_in_lo = {{2'd0}, a2l_fc_replay_link_cur_addr}; // @[FC.scala 350:45 FC.scala 351:39]
  wire [44:0] _link_data_in_T = {a2l_fc_replay_link_data,link_data_in_lo}; // @[Cat.scala 30:58]
  ...
  wire [15:0] _GEN_57 = a2l_fc_replay_link_valid & ~fe_rx_is_full ? 16'h6 : word_count; // @[FC.scala 523:63 FC.scala 527:39 FC.scala 429:39]
  wire [47:0] _GEN_58 = a2l_fc_replay_link_valid & ~fe_rx_is_full ? {{3'd0}, _link_data_in_T} : link_data; // @[FC.scala 523:63 FC.scala 528:39 FC.scala 430:39]
  ...
  wire [15:0] _GEN_65 = send_ack_req & _T_54 ? {{2'd0}, _word_count_in_T_4} : _GEN_57; // @[FC.scala 514:50 FC.scala 519:39]
  wire [47:0] _GEN_66 = send_ack_req & _T_54 ? 48'h0 : _GEN_58; // @[FC.scala 514:50 FC.scala 520:39]
  ...
  wire [15:0] _GEN_74 = send_nack_req ? {{2'd0}, _word_count_in_T_4} : _GEN_65; // @[FC.scala 505:28 FC.scala 510:39]
  wire [47:0] _GEN_75 = send_nack_req ? 48'h0 : _GEN_66; // @[FC.scala 505:28 FC.scala 511:39]
  ...
  wire [47:0] _GEN_109 = auto_tx_out_advance ? _GEN_75 : link_data; // @[FC.scala 537:28 FC.scala 430:39]
  ...
  wire [15:0] _GEN_125 = send_nack_req ? {{2'd0}, _word_count_in_T_4} : _GEN_57; // @[FC.scala 586:30 FC.scala 591:39]
  wire [47:0] _GEN_126 = send_nack_req ? 48'h0 : _GEN_58; // @[FC.scala 586:30 FC.scala 592:39]
  ...
  wire [47:0] _GEN_135 = auto_tx_out_advance ? _GEN_126 : link_data; // @[FC.scala 582:28 FC.scala 430:39]
  ...
  wire [47:0] _GEN_145 = state == 3'h6 ? _GEN_135 : link_data; // @[FC.scala 578:57 FC.scala 430:39]
  ...
  wire [47:0] _GEN_156 = state == 3'h7 ? link_data : _GEN_145; // @[FC.scala 571:58 FC.scala 430:39]
  ...
  wire [47:0] _GEN_165 = state == 3'h5 ? _GEN_109 : _GEN_156; // @[FC.scala 534:58]
  ...
  wire [47:0] _GEN_176 = state == 3'h4 ? _GEN_75 : _GEN_165; // @[FC.scala 501:58]
  ...
  WlinkCrcGen_2 rx_crc_computed_crcgen ( // @[LinkLayer.scala 1274:24]
  ...
  WlinkGenericFCReplayV2_2 l2a_fc_replay ( // @[FC.scala 219:43]
  ...
  WlinkGenericFCReplayAddrSync_3 l2a_fifo_addr_to_tx ( // @[FC.scala 241:43]
  ...
  WlinkGenericFCReplayV2_3 a2l_fc_replay ( // @[FC.scala 297:43]
  ...
  WlinkCrcGen_2 bundleOut_0_crc_crcgen ( // @[LinkLayer.scala 1274:24]
  ...
  assign l2a_fc_replay_app_data = ll_rx_data[36:0]; // @[FC.scala 223:35]
  ...
  assign a2l_fc_replay_link_ack_addr = ack_nack_fifo_io_rdata[5:0]; // @[FC.scala 334:64]
  assign a2l_fc_replay_link_revert = ack_nack_fifo_io_rdata[18:16] == 3'h3 & ack_nack_fifo_valid; // @[FC.scala 290:73]
  assign a2l_fc_replay_link_revert_addr = ~ack_seen_before ? 6'h0 : _link_revert_addr_T_6; // @[FC.scala 347:45]
  ...
  always @(posedge io_tx_clk or posedge io_tx_reset) begin
    if (io_tx_reset) begin
      l2a_fifo_raddr_txclk_prev <= 6'h0;
    end else begin
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_22 = {1{`RANDOM}};
  l2a_fifo_raddr_txclk_prev = _RAND_22[5:0];
  _RAND_23 = {1{`RANDOM}};
