...
module WlinkGenericFCSM_2(
  ...
  input  [13:0] io_app_a2l_data,
  output        io_app_a2l_ready,
  output        io_app_l2a_valid,
  output [13:0] io_app_l2a_data,
...
`endif // RANDOMIZE_REG_INIT
  wire [23:0] rx_crc_computed_crcgen_io_in; // @[LinkLayer.scala 1274:24]
  ...
  wire [13:0] l2a_fc_replay_app_data; // @[FC.scala 219:43]
  ...
  wire [13:0] l2a_fc_replay_link_data; // @[FC.scala 219:43]
  ...
  wire [13:0] a2l_fc_replay_app_data; // @[FC.scala 297:43]
  ...
  wire [13:0] a2l_fc_replay_link_data; // @[FC.scala 297:43]
  ...
  wire [23:0] bundleOut_0_crc_crcgen_io_in; // @[LinkLayer.scala 1274:24]
  wire [15:0] bundleOut_0_crc_crcgen_io_out; // @[LinkLayer.scala 1274:24]
  wire [15:0] ll_rx_data = auto_rx_in_data[23:8]; // @[FC.scala 122:33]
  ...
  reg [23:0] link_data; // @[FC.scala 324:48]
...
`endif
  ...
  wire [23:0] _GEN_38 = auto_tx_out_advance ? 24'h0 : link_data; // @[FC.scala 459:28 FC.scala 430:39]
  ...
  wire [21:0] _link_data_in_T = {a2l_fc_replay_link_data,link_data_in_lo}; // @[Cat.scala 30:58]
  ...
  wire [15:0] _GEN_57 = a2l_fc_replay_link_valid & ~fe_rx_is_full ? 16'h3 : word_count; // @[FC.scala 523:63 FC.scala 527:39 FC.scala 429:39]
  wire [23:0] _GEN_58 = a2l_fc_replay_link_valid & ~fe_rx_is_full ? {{2'd0}, _link_data_in_T} : link_data; // @[FC.scala 523:63 FC.scala 528:39 FC.scala 430:39]
  ...
  wire [23:0] _GEN_66 = send_ack_req & _T_54 ? 24'h0 : _GEN_58; // @[FC.scala 514:50 FC.scala 520:39]
  ...
  wire [23:0] _GEN_75 = send_nack_req ? 24'h0 : _GEN_66; // @[FC.scala 505:28 FC.scala 511:39]
  ...
  wire [23:0] _GEN_109 = auto_tx_out_advance ? _GEN_75 : link_data; // @[FC.scala 537:28 FC.scala 430:39]
...
`endif
  ...
  wire [23:0] _GEN_126 = send_nack_req ? 24'h0 : _GEN_58; // @[FC.scala 586:30 FC.scala 592:39]
  ...
  wire [23:0] _GEN_135 = auto_tx_out_advance ? _GEN_126 : link_data; // @[FC.scala 582:28 FC.scala 430:39]
  ...
  wire [23:0] _GEN_145 = state == 3'h6 ? _GEN_135 : link_data; // @[FC.scala 578:57 FC.scala 430:39]
  ...
  wire [23:0] _GEN_156 = state == 3'h7 ? link_data : _GEN_145; // @[FC.scala 571:58 FC.scala 430:39]
  ...
  wire [23:0] _GEN_165 = state == 3'h5 ? _GEN_109 : _GEN_156; // @[FC.scala 534:58]
  ...
  wire [23:0] _GEN_176 = state == 3'h4 ? _GEN_75 : _GEN_165; // @[FC.scala 501:58]
  ...
  WlinkCrcGen_4 rx_crc_computed_crcgen ( // @[LinkLayer.scala 1274:24]
  ...
  WlinkGenericFCReplayV2_4 l2a_fc_replay ( // @[FC.scala 219:43]
  ...
  WlinkGenericFCReplayV2_5 a2l_fc_replay ( // @[FC.scala 297:43]
  ...
  WlinkCrcGen_4 bundleOut_0_crc_crcgen ( // @[LinkLayer.scala 1274:24]
  ...
  assign l2a_fc_replay_app_data = ll_rx_data[13:0]; // @[FC.scala 223:35]
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      out_prepend_swi_crack_id <= 8'h11;
