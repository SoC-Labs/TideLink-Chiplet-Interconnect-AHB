module WlinkGenericFCSM_4(
  ...
  input  [46:0] io_app_a2l_data,
  output        io_app_a2l_ready,
  output        io_app_l2a_valid,
  output [46:0] io_app_l2a_data,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [46:0] l2a_fc_replay_app_data; // @[FC.scala 219:43]
  ...
  wire [46:0] l2a_fc_replay_link_data; // @[FC.scala 219:43]
  ...
  wire [46:0] a2l_fc_replay_app_data; // @[FC.scala 297:43]
  ...
  wire [46:0] a2l_fc_replay_link_data; // @[FC.scala 297:43]
  ...
  wire [47:0] ll_rx_data = auto_rx_in_data[55:8]; // @[FC.scala 122:33]
  ...
  wire [54:0] _link_data_in_T = {a2l_fc_replay_link_data,link_data_in_lo}; // @[Cat.scala 30:58]
  ...
  wire [55:0] _GEN_58 = a2l_fc_replay_link_valid & ~fe_rx_is_full ? {{1'd0}, _link_data_in_T} : link_data; // @[FC.scala 523:63 FC.scala 528:39 FC.scala 430:39]
  ...
  WlinkGenericFCReplayV2_8 l2a_fc_replay ( // @[FC.scala 219:43]
  ...
  WlinkGenericFCReplayV2_9 a2l_fc_replay ( // @[FC.scala 297:43]
  ...
  assign l2a_fc_replay_app_data = ll_rx_data[46:0]; // @[FC.scala 223:35]
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      out_prepend_swi_crack_id <= 8'h19;
