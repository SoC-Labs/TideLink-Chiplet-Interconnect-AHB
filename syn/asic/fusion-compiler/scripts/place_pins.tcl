...
#
# Clock distribution rationale: stacking all four clocks on a single edge
# (TOP) in the original revision was suspected as a hold-skew driver. The
# real root cause turned out to be pad_clk_rx → gpiorx_* capture latency
# under aspect 2.0 (fixed via place_logic.tcl gpio_phy_left bound), but
# the distributed-clock layout is the cleaner physical convention so it
# stays.
#
