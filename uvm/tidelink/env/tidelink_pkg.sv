...
package tidelink_pkg;
  ...
  parameter REG_TOKEN_COUNT    = 12'h00C;
  ...
  parameter REG_PAIR_TOKEN_COUNTER = 12'h028;
  parameter REG_PAIR_TOKEN_CONSUME = 12'h02C;
  parameter REG_PAIR_TOKEN_ENABLE  = 12'h030;
  ...
  parameter MAX_TOKENS  = (1 << (RAM_ADDR_W - 2)); // 4096
