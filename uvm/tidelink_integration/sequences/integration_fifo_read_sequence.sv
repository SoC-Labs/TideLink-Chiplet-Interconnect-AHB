...
//
// Packet format (same as unit-level ahb_packet_read_sequence):
//   Beat 0: Read packet_word_length from address 0x0000
//   Beat 1..N: Read data words from address 0x0004, 0x0008, ...
//   Beat N (address = length * 4): triggers read completion
///////////////////////////////////////////////////////////////////////////////
...
class integration_fifo_read_sequence extends svt_ahb_master_transaction_base_sequence;
  ...
  virtual task body();
    ...
    `uvm_info("SEQ", $sformatf("FIFO reading packet: %0d data words", num_words), UVM_MEDIUM)
