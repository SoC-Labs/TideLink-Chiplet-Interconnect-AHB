...
//
// Contains 6 SVT AHB system envs (3 per chiplet side), plus a system-level
...
class sys_cfg_ahb_config extends svt_ahb_system_configuration;
  `uvm_object_utils(sys_cfg_ahb_config)
  function new(string name = "sys_cfg_ahb_config");
    super.new(name);
    this.num_masters = 1;
    this.num_slaves  = 1;
    this.create_sub_cfgs(1, 1);
...
class tidelink_system_env extends uvm_env;
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    a_cfg_cfg  = sys_cfg_ahb_config::type_id::create("a_cfg_cfg");
    b_cfg_cfg  = sys_cfg_ahb_config::type_id::create("b_cfg_cfg");
